...
apt-get install -y unzip git openjdk-7-jdk jenkins gradle
...
su - jenkins -c 'wget -q -O /var/lib/jenkins/plugins/gradle.hpi http://updates.jenkins-ci.org/latest/gradle.hpi'
